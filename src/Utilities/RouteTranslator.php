<?php namespace Xannn94\Localization\Utilities;

use Xannn94\Localization\Contracts\RouteTranslatorInterface;
use Xannn94\Localization\Entities\LocaleCollection;
use Xannn94\Localization\Exceptions\InvalidTranslationException;
use Illuminate\Translation\Translator;

/**
 * Class     RouteTranslator
 *
 * @package  Xannn94\Localization\Utilities
...
class RouteTranslator implements RouteTranslatorInterface
{
     ...
     * @param  \Xannn94\Localization\Entities\LocaleCollection  $supportedLocales
     *
     * @return string|false
     */
